...
FixedText::FixedText(Point2f position, Float depth, Vector2f letter_size,
    ...
    : Entity{ position, depth, letter_size, font_texture, engine, _class_name, false, Entity::Collision_type::NO_COLLISION, Entity::Cursor_collision_type::AABB, _class_name},
