...
template <typename T>
constexpr Matrix4x4<T>::Matrix4x4() // Creates the identity matrix
{
...
template <typename T>
constexpr Matrix4x4<T>::Matrix4x4 (T other[])
{
...
template <typename T>
constexpr Matrix4x4<T>::Matrix4x4(T m00, T m01, T m02, T m03,
...
template <typename T>
constexpr Matrix4x4<T>::Matrix4x4(const Matrix4x4<T>& other)
{
...
template <typename T>
constexpr Matrix4x4<T> Matrix4x4<T>::operator*(Matrix4x4<T> const& obj) const
{
    Matrix4x4<T> result;
...
template <typename T>
constexpr Matrix4x4<T> Matrix4x4<T>::operator*(T const& obj) const 
{
    Matrix4x4<T> result;
...
template <typename T>
constexpr const T* Matrix4x4<T>::operator[](int i) const
{
    return m[i];
}
...
template <typename T>
constexpr bool Matrix4x4<T>::operator==(Matrix4x4<T> const& obj) const
{
    bool result = true;
...
template <typename T>
constexpr void Matrix4x4<T>::get_array(T array[]) const
{
