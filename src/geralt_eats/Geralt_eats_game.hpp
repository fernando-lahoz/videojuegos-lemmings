...
public:
    ...
    void on_game_startup(Engine &engine) override
    {
        ...
        auto ground = std::make_shared<Rigid_body>(Point3f(0, 0.7, 0), Vector2f(1, 0.3), t2, engine, "MAP");
        ...
        Music canon = mixer.load_music("assets/music/02_Lemming 1 (Pachebel's Canon).mp3", 128);
