...
class Gate_trigger : public Trigger
{
  bool change = false;
  bool init = false;
  bool is_debug = false;
...
public:
  Gate_trigger(Point3f position, Vector2f diagonal, Engine &engine, bool debug = false) : Trigger(position, diagonal, engine, "GATE TRIGGER")
  {
    init = !debug;
    is_debug = debug;
  }
