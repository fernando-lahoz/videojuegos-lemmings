...
public:
  ...
  {
    // hitbox = std::make_shared<Rigid_body>(Point3f(position.x + 40, position.y + 60, position.z - 1), Vector2f(8, 44), engine.load_texture("assets/gate/gate_hitbox.png"), engine, "Gate hitbox");
