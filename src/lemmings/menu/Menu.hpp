...
public:
  ...
  void setup_menu(Engine &engine, int type, int level, int difficulty)
  {
    ...
    else if (type == Utils::LEVEL_SELECTOR)
    {
      ...
      auto text = std::make_shared<Text_displayer>(Point3f(10170, 235, 2), Vector2f(8, 15), game_info, "center",
                                                  engine.load_texture("assets/font/font-blue.png"),
                                                  Vector2i(16, 30), lemmings_font_map, "Saved Lemmings", engine,
                                                  "TEXT");
      engine.get_game().create_entity(text);

      text = std::make_shared<Text_displayer>(Point3f(10470, 235, 2), Vector2f(8, 15), game_info, "center",
                                              engine.load_texture("assets/font/font-blue.png"),
                                              Vector2i(16, 30), lemmings_font_map, "Time", engine,
                                              "TEXT");
      engine.get_game().create_entity(text);
    ...
    else if (type == Utils::MENU_TYPE::CONFIG)
    {
      ...
      auto b_sonido = std::make_shared<Entity>(Point3f(x_b, 35, 2), Vector2f(200, 80), engine.load_texture("assets/menu/menu_button_wide.png"), engine, "Background", "Background");
      engine.get_game().create_entity(b_sonido);

      // Sliders del sonido
      auto s_musica = std::make_shared<Menu_slider>(Point3f(x_b + 50, 74, 1), 150, Vector2f(12, 12), 0, engine, game_info);
      engine.get_game().create_entity(s_musica);
      auto s_efectos = std::make_shared<Menu_slider>(Point3f(x_b + 50, 90, 1), 150, Vector2f(12, 12), 1, engine, game_info);
      engine.get_game().create_entity(s_efectos);

      // Boton de reset
      auto b_reset = std::make_shared<Menu_button>(Point3f(x_b, 140, 2), Vector2f(80, 80), engine, game_info, keyboard, Utils::BUTTON_TYPE::RESET);
      engine.get_game().create_entity(b_reset);

      // Boton de guardado
      auto b_save = std::make_shared<Menu_button>(Point3f(x_b, 245, 2), Vector2f(80, 80), engine, game_info, keyboard, Utils::BUTTON_TYPE::SAVE);
      engine.get_game().create_entity(b_save);

      // Boton de reset
      b_reset = std::make_shared<Menu_button>(Point3f(x_b += 120, 140, 2), Vector2f(80, 80), engine, game_info, keyboard, Utils::BUTTON_TYPE::RESET);
      engine.get_game().create_entity(b_reset);

      // Boton de guardado
      b_save = std::make_shared<Menu_button>(Point3f(x_b, 245, 2), Vector2f(80, 80), engine, game_info, keyboard, Utils::BUTTON_TYPE::SAVE);
      engine.get_game().create_entity(b_save);
      ...
      auto dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                      engine.load_texture("assets/font/font-red.png"),
                                                      Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::ABILITY_1 - 8)),
                                                      4, Utils::BUTTON_TYPE::ABILITY_1 - 8);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::ABILITY_2 - 8)),
                                                 4, Utils::BUTTON_TYPE::ABILITY_2 - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::ABILITY_3 - 8)),
                                                 4, Utils::BUTTON_TYPE::ABILITY_3 - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::ABILITY_4 - 8)),
                                                 4, Utils::BUTTON_TYPE::ABILITY_4 - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::ABILITY_5 - 8)),
                                                 4, Utils::BUTTON_TYPE::ABILITY_5 - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::ABILITY_6 - 8)),
                                                 4, Utils::BUTTON_TYPE::ABILITY_6 - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::ABILITY_7 - 8)),
                                                 4, Utils::BUTTON_TYPE::ABILITY_7 - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::ABILITY_8 - 8)),
                                                 4, Utils::BUTTON_TYPE::ABILITY_8 - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::EXPLODE_ALL - 8)),
                                                 4, Utils::BUTTON_TYPE::EXPLODE_ALL - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::ABILITY_UP - 8)),
                                                 4, Utils::BUTTON_TYPE::ABILITY_UP - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::ABILITY_DOWN - 8)),
                                                 4, Utils::BUTTON_TYPE::ABILITY_DOWN - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::SPEED_UP - 8)),
                                                 4, Utils::BUTTON_TYPE::SPEED_UP - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::SPEED_DOWN - 8)),
                                                 4, Utils::BUTTON_TYPE::SPEED_DOWN - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::SPAWN_UP - 8)),
                                                 4, Utils::BUTTON_TYPE::SPAWN_UP - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::SPAWN_DOWN - 8)),
                                                 4, Utils::BUTTON_TYPE::SPAWN_DOWN - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::MAP_LEFT - 8)),
                                                 4, Utils::BUTTON_TYPE::MAP_LEFT - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::MAP_RIGHT - 8)),
                                                 4, Utils::BUTTON_TYPE::MAP_RIGHT - 8);
      engine.get_game().create_entity(dynamic_t);
      ...
      dynamic_t = std::make_shared<Text_dynamic>(Point3f(x_b + i_tx, y_b + 15, 1), Vector2f(16 * size_t, 30 * size_t), engine, game_info, "center",
                                                 engine.load_texture("assets/font/font-red.png"),
                                                 Vector2i(16, 30), lemmings_font_map, KeyBindings().InEvenToCh(game_info.get_conf_buttons(Utils::BUTTON_TYPE::PAUSE - 8)),
                                                 4, Utils::BUTTON_TYPE::PAUSE - 8);
      engine.get_game().create_entity(dynamic_t);
    }
    else if (type == Utils::MENU_TYPE::IA)
    {
      ...
      auto text = std::make_shared<Text_displayer>(Point3f(10320, 25, 2), Vector2f(16 * 1.25, 30 * 1.25), game_info, "center",
                                                   engine.load_texture("assets/font/font-red.png"),
                                                   Vector2i(16, 30), lemmings_font_map, "1 VS IA", engine,
                                                   "TEXT");
      engine.get_game().create_entity(text);
