  ...
  void setup_level(Engine &engine, int level_number, int difficulty_number = 0)
  {
    ...
    case 0:
      ...
      case 0:
      {
        ...
        auto door = std::make_shared<Door>(Point3f(420, 20, 4), engine, 1, 1.0f, level_number, game_info);
      ...
      case 1:
      {
        ...
        auto door = std::make_shared<Door>(Point3f(1462.7, 73.5361, 4), engine, 8, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1302.94, 16.5413, 4), engine, 5, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1422.52, 9.87284, 4), engine, 5, 1.0f, level_number, game_info);
      ...
      case 4:
      {
        ...
        auto door = std::make_shared<Door>(Point3f(1403.21, 23.9217, 4), engine, 4, 1.0f, level_number, game_info);
        auto gate = std::make_shared<Gate>(Point3f(1728.38, -8.13497, 4), engine, 3, 0.8f, game_info);

        engine.get_game().create_entity(std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 0), Vector2f(txt.get_width() * 2, txt.get_height() * 2), engine.load_texture(basic_path + std::to_string(level_number) + "_2.png"), "MAP"));
      ...
      case 5:
      {
        ...
        auto door = std::make_shared<Door>(Point3f(987.409, 54.0332, 4), engine, 2, 1.0f, level_number, game_info);
      ...
      case 6:
      {
        ...
        auto door = std::make_shared<Door>(Point3f(1273.93, 43.2726, 4), engine, 3, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 1), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(965.748, 158.484, 4), engine, 4, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1129.81, 73.1607, 4), engine, 5, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 0), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1395.32, 160.534, 4), engine, 4, 1.0f, level_number, game_info);
        auto gate = std::make_shared<Gate>(Point3f(1688.35, 144.29, 4), engine, 3, 0.8f, game_info);

        engine.get_game().create_entity(std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), engine.load_texture(basic_path + std::to_string(level_number) + "_2.png"), "MAP"));
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 0), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1544.38, 8.23047, 4), engine, 5, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1307.35, 146.715, 4), engine, 4, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1276.3, 157.29, 4), engine, 5, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(736.777, 24.0139, 4), engine, 3, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 0), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(814.29, 28.0416, 4), engine, 5, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(442.924, 29.0666, 4), engine, 5, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1203.84, 192.863, 4), engine, 3, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1632.93, 71.9481, 4), engine, 4, 1.0f, level_number, game_info);
        engine.get_game().create_entity(door);
        door = std::make_shared<Door>(Point3f(1503.39, 71.9481, 4), engine, 4, 1.0f, level_number, game_info);
        engine.get_game().create_entity(door);
        door = std::make_shared<Door>(Point3f(1375.35, 71.9481, 4), engine, 4, 1.0f, level_number, game_info);
        engine.get_game().create_entity(door);
        door = std::make_shared<Door>(Point3f(1248.95, 71.9481, 4), engine, 4, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1087.03, 2.41112, 4), engine, 3, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(941.84, 154.104, 4), engine, 4, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1275.41, 65.2479, 4), engine, 4, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(549.387, 85.5787, 4), engine, 8, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(696.153, 160.226, 4), engine, 8, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1254.74, 134.628, 4), engine, 3, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1275.02, 4.23079, 4), engine, 4, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1176.41, 200.15, 4), engine, 2, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1628.52, 18.1654, 4), engine, 5, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1302.33, 72.6464, 4), engine, 4, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1732.57, 6.88284, 4), engine, 3, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1976.31, 117.534, 4), engine, 5, 1.0f, level_number, game_info);
      ...
      {
        auto map = std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP");
        auto door = std::make_shared<Door>(Point3f(1533.2, 23.0913, 4), engine, 3, 1.0f, level_number, game_info);
      ...
      break;
    case 1:
      engine.get_game().create_entity(std::make_shared<Rigid_body>(Point3f(-(txt.get_width()) + 3168 / 2, 0, 2), Vector2f(txt.get_width() * 2, txt.get_height() * 2), txt, "MAP"));
      engine.get_game().create_entity(std::make_shared<Door>(Point3f(3168 / 2, 100, 4), engine, 8, 1.0f, level_number, game_info, true));
      engine.get_game().create_entity(std::make_shared<Gate>(Point3f(3168 / 2, 100, 4), engine, 0, 0.8f, game_info));
      switch (level_number)
      {
      case 0:
        break;
