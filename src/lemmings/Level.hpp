...
public:
  Level(Level_info &_level_info) : level_info(_level_info)
  {
  }

  void setup_level(Engine &engine, int levelNumber)
  {
    HUDs hud = HUDs(engine, level_info);
    level_info.start_level_info(levelNumber);
    ...
    case 0:
    {
      ...
      auto door = std::make_shared<Door>(Point3f(0.5, 0.0, 21), (0.713f / txt.get_height()) / 2, engine, 1, 1.0f, levelNumber, level_info);
    ...
    case 1:
    {
      ...
      auto door = std::make_shared<Door>(Point3f(0.239501, 0.17319, 21), (0.713f / txt.get_height()), engine, 8, 1.0f, levelNumber, level_info);
    ...
    {
      auto map = std::make_shared<Entity>(Point3f(-(size_map_x / 2) + 0.5, 0.018, 20), Vector2f(size_map_x, 0.713), txt, "MAP");
      auto door = std::make_shared<Door>(Point3f(-0.133339, 0.0629796, 21), (0.713f / txt.get_height()), engine, 8, 1.0f, levelNumber, level_info);
    ...
    {
      auto map = std::make_shared<Entity>(Point3f(-(size_map_x / 2) + 0.5, 0.018, 20), Vector2f(size_map_x, 0.713), txt, "MAP");
      auto door = std::make_shared<Door>(Point3f(0.134475, 0.036891, 21), (0.713f / txt.get_height()), engine, 8, 1.0f, levelNumber, level_info);
    ...
    {
      auto map = std::make_shared<Entity>(Point3f(-(size_map_x / 2) + 0.5, 0.018, 20), Vector2f(size_map_x, 0.713), txt, "MAP");
      auto door = std::make_shared<Door>(Point3f(0.106264, 0.0684061, 21), (0.713f / txt.get_height()), engine, 4, 1.0f, levelNumber, level_info);
    ...
    {
      auto map = std::make_shared<Entity>(Point3f(-(size_map_x / 2) + 0.5, 0.018, 20), Vector2f(size_map_x, 0.713), txt, "MAP");
      auto door = std::make_shared<Door>(Point3f(-0.83787, 0.139829, 21), (0.713f / txt.get_height()), engine, 2, 1.0f, levelNumber, level_info);
    ...
    {
      auto map = std::make_shared<Entity>(Point3f(-(size_map_x / 2) + 0.5, 0.018, 20), Vector2f(size_map_x, 0.713), txt, "MAP");
      auto door = std::make_shared<Door>(Point3f(-0.195214, 0.100042, 21), (0.713f / txt.get_height()), engine, 0, 1.0f, levelNumber, level_info);
    ...
    {
      auto map = std::make_shared<Entity>(Point3f(-(size_map_x / 2) + 0.5, 0.018, 20), Vector2f(size_map_x, 0.713), txt, "MAP");
      auto door = std::make_shared<Door>(Point3f(-0.907686, 0.351528, 21), (0.713f / txt.get_height()), engine, 4, 1.0f, levelNumber, level_info);
    ...
    {
      auto map = std::make_shared<Entity>(Point3f(-(size_map_x / 2) + 0.5, 0.018, 20), Vector2f(size_map_x, 0.713), txt, "MAP");
      auto door = std::make_shared<Door>(Point3f(-0.513304, 0.173287, 21), (0.713f / txt.get_height()), engine, 8, 1.0f, levelNumber, level_info);
    ...
    {
      auto map = std::make_shared<Entity>(Point3f(-(size_map_x / 2) + 0.5, 0.018, 20), Vector2f(size_map_x, 0.713), txt, "MAP");
      auto door = std::make_shared<Door>(Point3f(0.0780902, 0.371627, 21), (0.713f / txt.get_height()), engine, 4, 1.0f, levelNumber, level_info);
    ...
    {
      auto map = std::make_shared<Entity>(Point3f(-(size_map_x / 2) + 0.5, 0.018, 20), Vector2f(size_map_x, 0.713), txt, "MAP");
      auto door = std::make_shared<Door>(Point3f(0.409338, 0.0352269, 21), (0.713f / txt.get_height()), engine, 8, 1.0f, levelNumber, level_info);
    ...
    {
      auto map = std::make_shared<Entity>(Point3f(-(size_map_x / 2) + 0.5, 0.018, 20), Vector2f(size_map_x, 0.713), txt, "MAP");
      auto door = std::make_shared<Door>(Point3f(-0.11019, 0.338112, 21), (0.713f / txt.get_height()), engine, 4, 1.0f, levelNumber, level_info);
    ...
    {
      auto map = std::make_shared<Entity>(Point3f(-(size_map_x / 2) + 0.5, 0.018, 20), Vector2f(size_map_x, 0.713), txt, "MAP");
      auto door = std::make_shared<Door>(Point3f(-0.295, 0.18, 21), (0.713f / txt.get_height()), engine, 8, 1.0f, levelNumber, level_info, true);
