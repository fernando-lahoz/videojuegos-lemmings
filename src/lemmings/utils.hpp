...
namespace Utils
{
  ...
  // LEVEL DATA
  const int LEVEL_N_LEMMINGS[31] = {50, 1000, 10, 50, 10, 50, 50, 50, 100, 100, 20, 60, 80, 20, 80, 100, 80, 50, 70, 100, 50, 100, 100, 80, 30, 100, 2, 50, 100, 100, 60};
  ...
  const int LEVEL_SPAWN_VELOCITY[31] = {1, 1, 50, 50, 1, 50, 50, 50, 88, 99, 50, 50, 99, 1, 20, 40, 1, 99, 80, 20, 10, 50, 50, 50, 99, 99, 30, 1, 80, 90, 10};
