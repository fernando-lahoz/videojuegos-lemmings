...
namespace Utils
{
  ...
  const int LEVEL_SAVE_LEMMINGS[4][31] = {{7, 1, 1, 5, 10, 5, 10, 25, 95, 90, 10, 50, 40, 20, 60, 80, 50, 20, 50, 70, 40, 60, 80, 20, 20, 50, 2, 25, 60, 60, 40},
                                          ...
                                          {120, 99, 80, 100, 30, 45, 30, 98, 100, 20, 5, 50, 8, 99, 95, 80, 97, 90, 65, 64, 80, 20, 50, 95, 99, 90, 99, 60, 50, 95, 60},
  ...
  const double LEVEL_TIME_LIMIT[4][31] = {{60.f, 300.f, 300.f, 300.f, 300.f, 300.f, 300.f, 300.f, 300.f, 300.f, 300.f, 300.f, 300.f, 180.f, 360.f, 480.f, 480.f, 300.f, 300.f, 300.f, 300.f, 480.f, 300.f, 480.f, 300.f, 300.f, 300.f, 300.f, 300.f, 480.f, 300.f},
                                          ...
                                          {999.f, 240.f, 300.f, 140.f, 420.f, 300.f, 180.f, 180.f, 240.f, 240.f, 300.f, 240.f, 300.f, 360.f, 480.f, 360.f, 180.f, 420.f, 300.f, 120.f, 300.f, 120.f, 180.f, 300.f, 180.f, 240.f, 300.f, 300.f, 300.f, 240.f, 240.f},
                                          {999.f, 480.f, 360.f, 80.f, 100.f, 360.f, 260.f, 300.f, 300.f, 240.f, 300.f, 300.f, 300.f, 300.f, 320.f, 120.f, 80.f, 240.f, 540.f, 300.f, 300.f, 300.f, 300.f, 540.f, 60.f, 300.f, 480.f, 80.f, 420.f, 300.f, 540.f}};
  const int LEVEL_SPAWN_VELOCITY[4][31] = {{1, 50, 50, 50, 1, 50, 50, 50, 88, 99, 50, 50, 99, 1, 20, 40, 1, 99, 80, 20, 10, 50, 50, 50, 99, 99, 30, 1, 80, 90, 10},
                                           ...
                                           {1, 15, 30, 99, 1, 99, 1, 1, 55, 90, 1, 1, 1, 50, 70, 60, 10, 50, 1, 1, 85, 1, 75, 70, 99, 1, 50, 10, 1, 50, 20}};
  ...
  const std::string MUSIC_DIRECTORY = "assets/music/";
